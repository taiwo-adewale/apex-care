        ...
        <div className="flex flex-wrap justify-center">
          {featuredCustomers.map((cust, index) => (
            ...
            >
              ...
              before:w-0 before:h-0 before:absolute before:left-0 before:top-0 before:border-t-[3px] before:border-l-[3px] before:border-t-transparent before:border-l-transparent before:content-[''] before:transition-all before:duration-500 before:hover:w-10 before:hover:h-10 before:hover:border-l-primary before:hover:border-t-primary
              after:w-0 after:h-0 after:absolute after:right-0 after:bottom-0 after:border-b-[3px] after:border-r-[3px] after:border-b-transparent after:border-r-transparent after:content-[''] after:transition-all after:duration-500 after:hover:w-10 after:hover:h-10 after:hover:border-r-primary after:hover:border-b-primary
              "
              >
                <img
                  src={cust.image}
                  alt=""
                  className="w-full group-hover:scale-[0.8] transition-all duration-500"
                />
              </div>
            </div>
          ))}
